...
export const Nav = () => {
    return <nav> <input type="checkbox" id="open-menu" />
        ...
        <div className="link">
            ...
            <Link to={"/category/categoria-1"}><i className="fa-solid fa-store"></i>Categoria-1</Link>
            <Link to={"/category/categoria-2"}><i className="fa-solid fa-store"></i>Categoria-2</Link>
        </div>
    </nav>
}